...
int main(int argc,char **argv){
    ...
    while((opt = getopt(argc, argv, "a:R:L:b:q:g:"))!=-1){
        ...
        //something was given incorrectly
            ...
            std::cerr << "Usage: ./projectjj -a <value> -R <value> -L <value> -t <value> -base <value> -query <value> -ground <value>" << std::endl;
            return 1;
        }
    }
    // Check if file paths are not empty
    if(base_file_path.empty() || query_file_path.empty() || ground_file_path.empty()){
        std::cerr << "Usage: ./projectjj -a <value> -R <value> -k <value> -L <value> -t <value> -base <value> -query <value> -ground <value>" << std::endl;
        return 1;
    }
